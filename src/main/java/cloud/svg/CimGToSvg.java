...
public class CimGToSvg {
     ...
     * @since 2020/9/2 9:09
     */
    public static void parseGFiles() throws Exception {
    ...
    public static String getSvg(String name) {
        ...
        try {
            ...
            List<Node> eles = cimg.selectNodes("G/Layer/*");
            Set<String> symbols = new HashSet<String>();
            for (Node ele : eles) {
                Attribute devref = ((Element) ele).attribute("devref");
                if (devref != null) {
                    symbols.add(ele.getName() + "=" + devref.getValue());
                }
                Attribute id = ((Element) ele).attribute("id");
                Attribute voltype = ((Element) ele).attribute("voltype");
    ...
    private static Element getSymbol(String name, String href, Element defs) throws Exception {
        try {
            ...
            Element node = cimg.getRootElement().element(name);
            String center = node.attributeValue("AlignCenter");
            String id = node.attributeValue("id");
            centerMap.put(id, center);

            if (node.attributeValue("w") != null && node.attributeValue("h") != null) {
                String center0 = Double.valueOf(node.attributeValue("w")) / 2 + ","
                        + Double.valueOf(node.attributeValue("h")) / 2;
                center0Map.put(id, center0);
            }
            List<Node> layers = node.selectNodes("Layer");
            for (int i = 0; i < layers.size(); i++) {
                List<Element> eles = ((Element) layers.get(i)).elements();
                if (eles.isEmpty()) {
                    continue;
                }
    ...
    private static Element parseCimG(Element ele, Element parent, boolean isObj) {
        if (ObjectUtil.isNotEmpty(ele)) {
        if ("line".equals(ele.getName())) {
            ...
            return parseOneNode(ele, parent);
        } else if ("RcBreakerDis".equals(ele.getName())) {
            return parseOneNode(ele, parent);
        ...
        } else if ("TransformerDis".equals(ele.getName())) {
            return parseTwoNode(ele, parent);
    ...
    private static Element parseImage(Element ele, Element parent) {
    ...
    private static Element parseBus(Element ele, Element parent) {
    ...
    private static Element parseConnectLine(Element ele, Element parent) {
        int linewidth = Double.valueOf(ele.attributeValue("lw")).intValue();
    ...
    private static Element parseACLine(Element ele, Element parent) {
        String color = "rgb(" + ele.attributeValue("lc") + ")";
        String voltype = ele.attributeValue("voltype");
        if (voltype != null) {
    ...
    private static Element parseOneNode(Element ele, Element parent) {
        String color = "";
        String voltype = ele.attributeValue("voltype");
        if (voltype == null) {
        ...
        }//PMS2_30700000_404001.zwk.icn.g:PMS2_30700000_404001
        use.addAttribute("xlink:href", "#" + href + "_0_0");
        colorMap.put(ele.attributeValue("id"), color);
        return parent;
    }

    private static Element parseTwoNode(Element ele, Element parent) {
        String voltype1 = ele.attributeValue("voltype1");
    ...
    private static Element parseThreeNode(Element ele, Element parent) {
        String voltype1 = ele.attributeValue("voltype1");
        String color1 = colorConvert(voltype1);
        String voltype2 = ele.attributeValue("voltype2");
        String color2 = colorConvert(voltype2);
    ...
    private static Element parseLine(Element ele, Element parent, boolean isObj) {
        int startx = Double.valueOf(ele.attributeValue("x1")).intValue();
        int starty = Double.valueOf(ele.attributeValue("y1")).intValue();
        int endx = Double.valueOf(ele.attributeValue("x2")).intValue();
        int endy = Double.valueOf(ele.attributeValue("y2")).intValue();
    ...
    private static Element parseRect(Element ele, Element parent, boolean isObj) {
        int startx = Double.valueOf(ele.attributeValue("x")).intValue();
        int starty = Double.valueOf(ele.attributeValue("y")).intValue();
        int width = Double.valueOf(ele.attributeValue("w")).intValue();
        int height = Double.valueOf(ele.attributeValue("h")).intValue();
    ...
    private static Element parseCircle(Element ele, Element parent, boolean isObj) {
    ...
    private static Element parseEllipse(Element ele, Element parent, boolean isObj) {
        double cx = Double.valueOf(ele.attributeValue("cx")).doubleValue();
        double cy = Double.valueOf(ele.attributeValue("cy")).doubleValue();
    ...
    private static Element parseArc(Element ele, Element parent, boolean isObj) {
        try {
    ...
    private static Element parseTriangle(Element ele, Element parent, boolean isObj) {
        int startx = Double.valueOf(ele.attributeValue("x")).intValue();
        int starty = Double.valueOf(ele.attributeValue("y")).intValue();
        int width = Double.valueOf(ele.attributeValue("w")).intValue();
        int height = Double.valueOf(ele.attributeValue("h")).intValue();
    ...
    private static Element parsePolyline(Element ele, Element parent, boolean isObj) {
        int linewidth = Double.valueOf(ele.attributeValue("lw")).intValue();
        String linecolor = "rgb(" + ele.attributeValue("lc") + ")";
        Element polyline = parent.addElement("polyline");
        polyline.addAttribute("points", ele.attributeValue("d"));
    ...
    private static Element parsePolygon(Element ele, Element parent, boolean isObj) {
        int linewidth = Double.valueOf(ele.attributeValue("lw")).intValue();
        String linecolor = "rgb(" + ele.attributeValue("lc") + ")";
        Element polygon = parent.addElement("polygon");
    ...
    private static Element parseString(Element ele, Element parent, boolean isObj) {
        int startx = Double.valueOf(ele.attributeValue("x")).intValue();
        int starty = Double.valueOf(ele.attributeValue("y")).intValue();
...
//			text.addAttribute("y", starty + "");
    ...
    private static String colorConvert(String voltype) {
    ...
    private static String transByCenter(String transform, String center, String center0) {
        String result = "";
        try {
    ...
    private static String getTransform(String transform, String name) {
